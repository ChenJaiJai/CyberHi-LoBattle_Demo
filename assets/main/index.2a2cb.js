System.register("chunks:///_virtual/aes.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './cipher-core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "1706aAPoWBP95PWVsrrVtX6", "aes", undefined);
...
System.register("chunks:///_virtual/asn1.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './errors.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "ee4a9dc6BNLloeww+UKjG4V", "asn1", undefined); // import crypto, { isCryptoKey } from './webcrypto'
...
System.register("chunks:///_virtual/AutoFollow.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      var _dec, _class2;
      cclegacy._RF.push({}, "f48f3sZevpDIIrUpZmrPRbR", "AutoFollow", undefined);
...
System.register("chunks:///_virtual/base_client.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './connect.ts', './disconnect.ts', './mod2.ts', './pingreq.ts', './puback.ts', './pubcomp.ts', './publish.ts', './pubrec.ts', './pubrel.ts', './subscribe.ts', './unsubscribe.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "4a809m64Y9NoJ9Qsa32tPRh", "base_client", undefined);
...
System.register("chunks:///_virtual/base64url.ts", ['cc', './buffer_utils.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "9c582gmAyNDooSqDa+OVgk5", "base64url", undefined);
...
System.register("chunks:///_virtual/BaseComponent.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BasicEnum.ts', './CommonValue.ts', './EventMng.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      var _dec, _class;
      cclegacy._RF.push({}, "ab6ffXXzc1LPJkbt5vmZDiR", "BaseComponent", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
...
System.register("chunks:///_virtual/BasicAutoPlay.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseComponent.ts', './Public.ts', './BasicEnum.ts', './CustomEvent.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Button, find, Label, BaseComponent, setFunctionName, Plug, BasicEnum, CustomEvent, CEType;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
      ...
      var BasicAutoPlay = exports('default', (_dec = ccclass('BasicAutoPlay'), _dec2 = property({
        ...
        _proto.onLoad = function onLoad() {
          ...
          for (var index = 0; index < this.items.length; index++) {
            find("Label", this.items[index].node).getComponent(Label).string = this.roundDate[index];
...
System.register("chunks:///_virtual/BasicChip.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseComponent.ts', './Public.ts', './BasicEnum.ts', './CustomEvent.ts', './LabelButton.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, Prefab, Node, instantiate, find, Label, UITransform, Sprite, resources, SpriteFrame, BaseComponent, setFunctionName, Plug, BasicEnum, CustomEvent, CEType, LabelButton;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      var BasicChip = exports('default', (_dec = ccclass('BasicChip'), _dec2 = property({
        ...
        type: Node,
        tooltip: "籌碼放置位置"
      }), _dec(_class2 = (_class3 = /*#__PURE__*/function (_BaseComponent) {
              ...
              while (1) switch (_context3.prev = _context3.next) {
                case 0:
                  return _context3.abrupt("return", new Promise( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve, reject) {
                    var startTime, spriteFrames, GetToLenDate, i, _chipNode;
                    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                      while (1) switch (_context2.prev = _context2.next) {
                        case 0:
...
System.register("chunks:///_virtual/BasicPlaySelect.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Public.ts', './SpriteButton.ts', './BasicSelect.ts', './CustomEvent.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Plug, SpriteButton, BasicSelect, CustomEvent, CEType;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      var BasicPlaySelect = exports('default', (_dec = ccclass('BasicPlaySelect'), _dec2 = property({
         ...
         */
        _proto.onLoad = function onLoad() {
          CustomEvent.addEvent(CEType.ClickEvents, this, Plug.Model.getFunctionName(this.onSelect), this.btnPlay);
...
System.register("chunks:///_virtual/BasicRandomAutoPlay.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Public.ts', './SpriteButton.ts', './BasicAutoPlay.ts', './CustomEvent.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, setFunctionName, Plug, SpriteButton, BasicAutoPlay, CustomEvent, CEType;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
...
System.register("chunks:///_virtual/BasicRandomSelect.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Public.ts', './CommonValue.ts', './SpriteButton.ts', './BasicSelect.ts', './CustomEvent.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Label, random, Plug, CommonValue, SpriteButton, BasicSelect, BasicSendDate, CustomEvent, CEType;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
...
System.register("chunks:///_virtual/BasicSelect.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseComponent.ts', './Public.ts', './BasicEnum.ts', './CommonValue.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, BaseComponent, setFunctionName, BasicEnum, CommonValue;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      var BasicSelect = exports('default', (_dec = ccclass('BasicSelect'), _dec(_class = (_class2 = /*#__PURE__*/function (_BaseComponent) {
        ...
        _proto.onSelect = /*#__PURE__*/function () {
          var _onSelect = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e, customEventData) {
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
        ...
        _proto.processGameFlow = function processGameFlow() {
          // if (CommonValue.isAuto) this.loopGame()
          // else this.eventEmit(BasicEnum.SendAPI, this.rememberDate);
...
System.register("chunks:///_virtual/BasicVersion.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var BasicVersion = exports('default', (_dec = ccclass('BasicVersion'), _dec2 = property(Label), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        _inheritsLoose(BasicVersion, _Component);
        ...
        return BasicVersion;
      }(Component), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "labelVersion", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
System.register("chunks:///_virtual/blowfish.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './cipher-core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "18d22kPGaFH5abMkqQ7l2h8", "blowfish", undefined);
      var N = 16;
...
System.register("chunks:///_virtual/browser_client.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './base_client.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "0350bQcJ4VAqafewSdfGtty", "browser_client", undefined);
...
System.register("chunks:///_virtual/buffer_utils.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "dac94K/EMdK67FIUTtZ1BPn", "buffer_utils", undefined);
...
System.register("chunks:///_virtual/check_key_length.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "c1aa88WzaVOZJ3/c4eUJnMQ", "check_key_length", undefined);
...
System.register("chunks:///_virtual/check_key_type.ts", ['cc', './is_key_like.ts', './invalid_key_input.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "7a1f9nOy9tMs6YOZ5UULE2J", "check_key_type", undefined);
...
System.register("chunks:///_virtual/cipher-core.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './core.js', './enc-base64.js', './evpkdf.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "fff01KsSklCe7BEC6eSpQoe", "cipher-core", undefined);
...
System.register("chunks:///_virtual/CocosImage.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "adb88ZduA1HxaxDOjX/HzCg", "CocosImage", undefined);
...
System.register("chunks:///_virtual/connack.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "8f3d6f7xGNL1LYNd6GYLeo1", "connack", undefined);
...
System.register("chunks:///_virtual/connect.ts", ['cc', './length.ts', './utf8.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "8c943/04+lC+asIJU9InTC8", "connect", undefined);
...
System.register("chunks:///_virtual/core.js", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "4e159CoEfxCR4lCGoMcSF0M", "core", undefined);
...
System.register("chunks:///_virtual/CreateFileSprite.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "1cc32kCQ5hDJrIQTnWqXnJ1", "CreateFileSprite", undefined);
...
System.register("chunks:///_virtual/crypto_key.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "82fb0CFfndH+J/OaIKJ7hc/", "crypto_key", undefined);
...
System.register("chunks:///_virtual/DelayTime.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseSingleton.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "4226baAlQtBFrXb2Npe2UeE", "DelayTime", undefined);
      //#endregion
...
System.register("chunks:///_virtual/disconnect.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "e2ba0+DeEBLM5+l69TBPxTX", "disconnect", undefined);
...
System.register("chunks:///_virtual/EasyCode.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './AutoFollow.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "c8cb8+OiZhDvLWsed6uTcC8", "EasyCode", undefined);
...
System.register("chunks:///_virtual/enc-base64.js", ['cc', './core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "f73225LLchHG4SZ7NcJKReQ", "enc-base64", undefined);
...
System.register("chunks:///_virtual/enc-base64url.js", ['cc', './enc-base64.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "193742UXrBGtZ4GGe8rHx2q", "enc-base64url", undefined);
...
System.register("chunks:///_virtual/enc-utf16.js", ['cc', './core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "eb08f8gGPFH95KsInEzPVFY", "enc-utf16", undefined);
...
System.register("chunks:///_virtual/epoch.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "a5753qjaX1PX6cyaS8OHxAB", "epoch", undefined);
...
System.register("chunks:///_virtual/errors.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "e66cc8JD0hL04Xgop3/9on1", "errors", undefined);
...
System.register("chunks:///_virtual/EventMng.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseSingleton.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      var _dec, _class;
      cclegacy._RF.push({}, "f3df3MJ7/lOB5UytWEFG2kj", "EventMng", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
...
System.register("chunks:///_virtual/evpkdf.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './core.js', './md5.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "06462alPWZPYYfS/ywc9FTQ", "evpkdf", undefined);
...
System.register("chunks:///_virtual/format-hex.js", ['cc', './cipher-core.js', './core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "06ee88FUiNJO5XT4v+3Pz09", "format-hex", undefined);
...
System.register("chunks:///_virtual/get_sign_verify_key.ts", ['cc', './crypto_key.ts', './invalid_key_input.ts', './is_key_like.ts', './webcrypto.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "72641ECnE1I7pKmez5orB8g", "get_sign_verify_key", undefined);
...
System.register("chunks:///_virtual/GoogleSheet.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './index.ts', './SheetData.ts', './sign.ts', './import.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "1fb88tvX2RNHY1BPtsm8O1U", "GoogleSheet", undefined);
      /**
       * 
       */
...
System.register("chunks:///_virtual/hmac.js", ['cc', './core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "0ae60JgdYlBCJOIIlTVzJ+Q", "hmac", undefined);
      cclegacy._RF.pop();
    }
  };
});
...
System.register("chunks:///_virtual/import.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './asn1.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "22910amQXBN97lCHCEdflQz", "import", undefined);
...
System.register("chunks:///_virtual/index.js", ['cc', './core.js', './x64-core.js', './cipher-core.js', './enc-utf16.js', './enc-base64.js', './enc-base64url.js', './hmac.js', './md5.js', './sha1.js', './sha224.js', './sha256.js', './sha384.js', './sha512.js', './sha3.js', './ripemd160.js', './pbkdf2.js', './evpkdf.js', './aes.js', './tripledes.js', './rabbit.js', './rabbit-legacy.js', './rc4.js', './blowfish.js', './mode-cfb.js', './mode-ctr.js', './mode-ctr-gladman.js', './mode-ecb.js', './mode-ofb.js', './pad-ansix923.js', './pad-iso10126.js', './pad-iso97971.js', './pad-nopadding.js', './pad-zeropadding.js', './format-hex.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "59c09HqK91DfLxESfCfQbmV", "index", undefined);
...
System.register("chunks:///_virtual/index.ts", ['cc', './sign.ts', './import.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "672db5ktAVNepABev3CAQfx", "index", undefined);
      cclegacy._RF.pop();
    }
  };
});

System.register("chunks:///_virtual/index2.ts", ['cc', './browser_client.ts', './mod.ts', './mod2.ts'], function (exports) {
  var cclegacy;
  return {
    setters: [function (module) {
      cclegacy = module.cclegacy;
    ...
    execute: function () {
      cclegacy._RF.push({}, "fb3cahV+UpD9qBcbTS9JhmM", "index", undefined);
      cclegacy._RF.pop();
    }
  };
});
...
System.register("chunks:///_virtual/invalid_key_input.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "ca44aoloExHlp48Sv9fVscK", "invalid_key_input", undefined);
...
System.register("chunks:///_virtual/is_disjoint.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "321adO0iMFLoaQQXMp3aZBK", "is_disjoint", undefined);
...
System.register("chunks:///_virtual/is_key_like.ts", ['cc', './webcrypto.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "52a5aJ6gd1NjbdwDaR1o3MQ", "is_key_like", undefined);
...
System.register("chunks:///_virtual/is_object.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "c5034/VuTJKRKl5xitJMD/Q", "is_object", undefined);
...
System.register("chunks:///_virtual/LanguageManager.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseSingleton.ts', './Public.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "d89f7wmeLhAPrlIVx2XtJME", "LanguageManager", undefined);
...
System.register("chunks:///_virtual/length.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "9ba16uZeJJEaIifZOUUVm5G", "length", undefined);
...
System.register("chunks:///_virtual/LookTex.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      var _dec, _class;
      cclegacy._RF.push({}, "b814dVJpJRKR4bv2aKPuQNZ", "LookTex", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
...
System.register("chunks:///_virtual/M4Bonus.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './M4SFBonus.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Layout, Sprite, M4SFBonus;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
      ...
      M4SFBonus = module.default;
    }],
    execute: function () {
      var _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3;
      cclegacy._RF.push({}, "a1540Eqk6FFcY5rIGWMqJox", "M4Bonus", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var M4Bonus = exports('default', (_dec = ccclass('M4Bonus'), _dec2 = property({
        type: Layout
      }), _dec3 = property({
        type: Sprite
      }), _dec4 = property(Sprite), _dec(_class = (_class2 = /*#__PURE__*/function (_M4SFBonus) {
        _inheritsLoose(M4Bonus, _M4SFBonus);
        function M4Bonus() {
          var _this;
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _M4SFBonus.call.apply(_M4SFBonus, [this].concat(args)) || this;
          _initializerDefineProperty(_this, "layout", _descriptor, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "energyBars", _descriptor2, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "energys", _descriptor3, _assertThisInitialized(_this));
          return _this;
        }
        var _proto = M4Bonus.prototype;
        _proto.orientationEvent = function orientationEvent(isLandscape) {
          if (isLandscape) {
            this.energyBars.enabled = false;
            for (var index = 0; index < this.energys.length; index++) {
              this.energys[index].spriteFrame = this.orientationSprite.web_Energy;
            }
            this.layout.paddingTop = 9;
            this.layout.spacingY = 5.85;
          } else {
            this.energyBars.enabled = true;
            for (var _index = 0; _index < this.energys.length; _index++) {
              this.energys[_index].spriteFrame = this.orientationSprite.mobile_Energy;
            }
            this.layout.paddingTop = 20.5;
            this.layout.spacingY = 12.55;
          }
        };
        return M4Bonus;
      }(M4SFBonus), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "layout", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "energyBars", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "energys", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
System.register("chunks:///_virtual/M4Enum.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BasicEnum.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      var M4Select = exports('M4Select', /*#__PURE__*/function (M4Select) {
        M4Select["Spade"] = "Spade";
        M4Select["Heart"] = "Heart";
        return M4Select;
      }({}));
      cclegacy._RF.pop();
    }
...
System.register("chunks:///_virtual/M4Gamer.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Public.ts', './M4SFGamer.ts', './CommonValue.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Sprite, Vec3, tween, v3, easing, Plug, SuitType, M4SFGamer, CommonValue;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
      ...
      SuitType = module.SuitType;
      M4SFGamer = module.default;
    }, function (module) {
      CommonValue = module.default;
    }],
    execute: function () {
      var _dec, _dec2, _class, _class2, _descriptor;
      cclegacy._RF.push({}, "44ab4RsrQ9LMaMvKncpIGXX", "M4Gamer", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var M4Gamer = exports('default', (_dec = ccclass('M4Gamer'), _dec2 = property({
        type: Sprite,
        tooltip: "Card圖片"
      }), _dec(_class = (_class2 = /*#__PURE__*/function (_M4SFGamer) {
        _inheritsLoose(M4Gamer, _M4SFGamer);
        function M4Gamer() {
          var _this;
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _M4SFGamer.call.apply(_M4SFGamer, [this].concat(args)) || this;
          _initializerDefineProperty(_this, "spriteCard", _descriptor, _assertThisInitialized(_this));
          _this.currentCard = 0;
          return _this;
        }
        var _proto = M4Gamer.prototype;
        _proto.winGame = function winGame(_actionTime, _showDelayTime, _winDelayTime) {
          var org = new Vec3(this.spriteCard.node.position);
          var scale = new Vec3(this.spriteCard.node.scale);
          var Action;
          switch (this.suit) {
            case SuitType.Spade:
              Action = tween(this.spriteCard.node).delay(_showDelayTime).by(_actionTime, {
                position: v3(20),
                scale: v3(0.3, 0.3)
              }, {
                easing: "backOut"
              }).delay(_winDelayTime).to(_actionTime, {
                position: org,
                scale: scale
              }, {
                easing: "backOut"
          ...
          Action.call(function (x) {
            return CommonValue.endShow = true;
          });
          Action.start();
          //基礎速率+(基礎速率+變化值)，因為如果直接相乘，level0就不會動了
          var actionSpeed = 1 + 1 * CommonValue.turboLevel;
          Plug.Model.changeTweenSpeed(Action, actionSpeed);
        };
        _proto.lostGame = function lostGame() {};
        _proto.setCardSprite = function setCardSprite(cardNumber) {
          this.currentCard = cardNumber;
          this.spriteCard.spriteFrame = this.spriteFrames.get(cardNumber);
        };
        _proto.orientationEvent = function orientationEvent(isLandscape) {
          _M4SFGamer.prototype.orientationEvent.call(this, isLandscape);
          //原本的圖片要替換掉
          this.setCardSprite(this.currentCard);
        };
        return M4Gamer;
      }(M4SFGamer), _descriptor = _applyDecoratedDescriptor(_class2.prototype, "spriteCard", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
System.register("chunks:///_virtual/M4PanelAutoPlay.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './M4Enum.ts', './BasicRandomAutoPlay.ts', './SpriteButton.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, M4Select, BasicRandomAutoPlay, SpriteButton;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
      ...
      M4Select = module.M4Select;
    }, function (module) {
      BasicRandomAutoPlay = module.default;
    }, function (module) {
      SpriteButton = module.default;
    }],
    execute: function () {
      var _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2;
      cclegacy._RF.push({}, "4a1bfMrTxtDQaYazWEAR5Qu", "M4PanelAutoPlay", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var M4PanelAutoPlay = exports('default', (_dec = ccclass('M4PanelAutoPlay'), _dec2 = property({
        type: SpriteButton,
        tooltip: "黑桃下注按鈕"
      }), _dec3 = property({
        type: SpriteButton,
        tooltip: "愛心下注按鈕"
      }), _dec(_class = (_class2 = /*#__PURE__*/function (_BasicRandomAutoPlay) {
        _inheritsLoose(M4PanelAutoPlay, _BasicRandomAutoPlay);
        function M4PanelAutoPlay() {
          var _this;
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _BasicRandomAutoPlay.call.apply(_BasicRandomAutoPlay, [this].concat(args)) || this;
          _initializerDefineProperty(_this, "btnSpade", _descriptor, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "btnHeart", _descriptor2, _assertThisInitialized(_this));
          return _this;
        }
        var _proto = M4PanelAutoPlay.prototype;
        _proto.onLoad = function onLoad() {
          this.setBtnMap(M4Select, this.btnSpade, this.onSelectBet);
          this.setBtnMap(M4Select, this.btnHeart, this.onSelectBet);
          _BasicRandomAutoPlay.prototype.onLoad.call(this);
        };
        return M4PanelAutoPlay;
      }(BasicRandomAutoPlay), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "btnSpade", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "btnHeart", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
System.register("chunks:///_virtual/M4PanelBetInfo.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BasicSFBetInfo.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, v3, Vec3, BasicSFBetInfo;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
    ...
    execute: function () {
      ...
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var M4PanelBetInfo = exports('default', (_dec = ccclass('PanelBetInfo'), _dec(_class = /*#__PURE__*/function (_BasicSFBetInfo) {
        _inheritsLoose(M4PanelBetInfo, _BasicSFBetInfo);
...
System.register("chunks:///_virtual/M4PanelBetSelect.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Public.ts', './M4Enum.ts', './M4SFSelect.ts', './BasicRandomSelect.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, v3, Vec3, Plug, M4Select, M4SFSelect, Select, BasicRandomSendDate;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
      ...
      M4SFSelect = module.default;
    }, function (module) {
      Select = module.Select;
      BasicRandomSendDate = module.BasicRandomSendDate;
    }],
    execute: function () {
      var _dec, _class;
      cclegacy._RF.push({}, "f2390T9OQZPipjcM/OItZiy", "M4PanelBetSelect", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var M4PanelBetSelect = exports('default', (_dec = ccclass('M4PanelBetSelect'), _dec(_class = /*#__PURE__*/function (_M4SFSelect) {
        _inheritsLoose(M4PanelBetSelect, _M4SFSelect);
        function M4PanelBetSelect() {
          var _this;
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _M4SFSelect.call.apply(_M4SFSelect, [this].concat(args)) || this;
          _this.rememberDate = void 0;
          return _this;
        }
        var _proto = M4PanelBetSelect.prototype;
        _proto.onLoad = function onLoad() {
          console.log(Object.values(M4Select).includes(M4Select.Heart));
          this.setBtnMap(M4Select, this.btnHeart, this.onSelect);
          this.setBtnMap(M4Select, this.btnSpade, this.onSelect);
          this.setSelectEnum(M4Select);
          _M4SFSelect.prototype.onLoad.call(this);
        };
        _proto.updateSelection = function updateSelection(e, customEventData) {
          if (!Plug.Model.checkHasEnum(M4Select, customEventData) && !Plug.Model.checkHasEnum(Select, customEventData)) throw new Error("node物件命名有問題，規則應為btn${enum名稱}");
          this.changeBtnStatus(this.getCompo(customEventData), true);
          this.currentSelect = customEventData;
        };
        _proto.PacketBuild = function PacketBuild() {
          //     _request = await new Request(sys.isMobile)
          //         .SwitchGetData("")
          this.rememberDate = new M4SendDate();
          if (this.currentSelect == Select.Random) this.randomSelect();else this.rememberDate.select = this.currentSelect;
        };
        _proto.orientationEvent = function orientationEvent(isLandscape) {
          _M4SFSelect.prototype.orientationEvent.call(this, isLandscape);
          if (isLandscape) {
            this.btnHeart.node.setPosition(v3(234, 0));
            this.btnRandom.node.setPosition(Vec3.ZERO);
            this.btnSpade.node.setPosition(v3(-234, 0));
            this.labelHeart.node.active = false;
            this.labelRandom.node.active = false;
            this.labelSpade.node.active = false;
            this.labelHeart.node.setPosition(v3(234, -40));
            this.labelRandom.node.setPosition(v3(0, -40));
            this.labelSpade.node.setPosition(v3(-234, -40));
            this.labelHeart.fontSize = 20;
            this.labelRandom.fontSize = 20;
            this.labelSpade.fontSize = 20;
            this.labelHeart.lineHeight = 40;
            this.labelRandom.lineHeight = 40;
            this.labelSpade.lineHeight = 40;
          } else {
            this.btnHeart.node.setPosition(v3(285, -178));
            this.btnRandom.node.setPosition(v3(0, -178));
            this.btnSpade.node.setPosition(v3(-285, -178));
            this.labelHeart.node.active = true;
            this.labelRandom.node.active = true;
            this.labelSpade.node.active = true;
            this.labelHeart.node.setPosition(v3(283, -248));
            this.labelRandom.node.setPosition(v3(0, -248));
            this.labelSpade.node.setPosition(v3(-283, -248));
            this.labelHeart.fontSize = 38;
            this.labelRandom.fontSize = 38;
            this.labelSpade.fontSize = 38;
            this.labelHeart.lineHeight = 60;
            this.labelRandom.lineHeight = 60;
            this.labelSpade.lineHeight = 60;
          }
        };
        return M4PanelBetSelect;
      }(M4SFSelect)) || _class));
      var M4SendDate = exports('M4SendDate', /*#__PURE__*/function (_BasicRandomSendDate) {
        _inheritsLoose(M4SendDate, _BasicRandomSendDate);
        function M4SendDate() {
          return _BasicRandomSendDate.apply(this, arguments) || this;
        }
        return M4SendDate;
      }(BasicRandomSendDate));
      cclegacy._RF.pop();
...
System.register("chunks:///_virtual/M4PanelBG.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './M4SFBG.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Sprite, M4SFBG;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
      ...
      M4SFBG = module.default;
    }],
    execute: function () {
      var _dec, _dec2, _class, _class2, _descriptor;
      cclegacy._RF.push({}, "49e82qqOHJOK4hJToSYEuQ1", "M4PanelBG", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var M4PanelBG = exports('default', (_dec = ccclass('M4PanelBG'), _dec2 = property(Sprite), _dec(_class = (_class2 = /*#__PURE__*/function (_M4SFBG) {
        _inheritsLoose(M4PanelBG, _M4SFBG);
        function M4PanelBG() {
          var _this;
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        ...
        var _proto = M4PanelBG.prototype;
        _proto.orientationEvent = function orientationEvent(isLandscape) {
          this.bg.spriteFrame = isLandscape ? this.orientationSprite.web_bg : this.orientationSprite.mobile_bg;
        };
        return M4PanelBG;
      }(M4SFBG), _descriptor = _applyDecoratedDescriptor(_class2.prototype, "bg", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
System.register("chunks:///_virtual/M4PanelBonus.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseComponent.ts', './M4Bonus.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, v3, BaseComponent, M4Bonus;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
      ...
      M4Bonus = module.default;
    }],
    execute: function () {
      var _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2;
      cclegacy._RF.push({}, "6f69cnrM4xKVZ3kzvSys1/U", "M4PanelBonus", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var M4PanelBonus = exports('default', (_dec = ccclass('M4PanelBonus'), _dec2 = property(M4Bonus), _dec3 = property(M4Bonus), _dec(_class = (_class2 = /*#__PURE__*/function (_BaseComponent) {
        _inheritsLoose(M4PanelBonus, _BaseComponent);
        function M4PanelBonus() {
          var _this;
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
        ...
        var _proto = M4PanelBonus.prototype;
        _proto.orientationEvent = function orientationEvent(isLandscape) {
          if (isLandscape) {
            this.left.node.setPosition(v3(-351, 144));
            this.right.node.setPosition(v3(351, 144));
          } else {
...
System.register("chunks:///_virtual/M4PanelChip.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BasicChip.ts'], function (exports) {
  var _inheritsLoose, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, size, Vec3, v3, BasicChip;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
      _asyncToGenerator = module.asyncToGenerator;
...
System.register("chunks:///_virtual/M4PanelGameShow.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Public.ts', './CommonValue.ts', './BasicGameShow.ts', './M4Gamer.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, Label, tween, v3, Vec3, Plug, CommonValue, BasicGameShow, M4Gamer;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
      ...
      M4Gamer = module.default;
    }],
    execute: function () {
      var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6;
      cclegacy._RF.push({}, "fa2de1KiYlPp4/5YM2e71dp", "M4PanelGameShow", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var M4PanelGameShow = exports('default', (_dec = ccclass('M4PanelGameShow'), _dec2 = property({
        type: M4Gamer,
        tooltip: "Spade"
      }), _dec3 = property({
        type: M4Gamer,
        ...
        tooltip: "放大後顯示時間"
      }), _dec(_class = (_class2 = /*#__PURE__*/function (_BasicGameShow) {
        _inheritsLoose(M4PanelGameShow, _BasicGameShow);
        function M4PanelGameShow() {
          var _this;
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _BasicGameShow.call.apply(_BasicGameShow, [this].concat(args)) || this;
          _initializerDefineProperty(_this, "spade", _descriptor, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "heart", _descriptor2, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "labelResult", _descriptor3, _assertThisInitialized(_this));
          _this.gameAction = void 0;
          _initializerDefineProperty(_this, "actionTime", _descriptor4, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "showDelayTime", _descriptor5, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "winDelayTime", _descriptor6, _assertThisInitialized(_this));
          return _this;
        }
        var _proto = M4PanelGameShow.prototype;
        _proto.start = /*#__PURE__*/function () {
          var _start = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  this.labelResult.string = "歡迎來到耍大牌\n\r比大小";
                  this.heart.setCardSprite(0);
                  this.spade.setCardSprite(0);
        ...
        _proto.showWin = function showWin(result) {
          CommonValue.endShow = false;
          this.heart.setCardSprite(result.heartCard);
          this.spade.setCardSprite(result.spadeCard);
          var resultStr = "";
          if (result.isHeartWin) {
            resultStr += result.heartCard + "\u724C\u7372\u52DD";
            this.heart.winGame(this.actionTime, this.showDelayTime, this.winDelayTime);
          } else {
            resultStr += result.spadeCard + "\u724C\u7372\u52DD";
            this.spade.winGame(this.actionTime, this.showDelayTime, this.winDelayTime);
          }
          tween(this.node).updateUntil(function (t, dt) {
            return CommonValue.endShow;
          }).call(this.endShow.bind(this)).start();
          console.log(result.winPoint);
          if (result.winPoint > 0) resultStr += "\n\rWinPoint:" + result.winPoint;
          this.labelResult.string = resultStr;
        };
        _proto.endShow = function endShow() {
          this.heart.setCardSprite(0);
          this.spade.setCardSprite(0);
        ...
        _proto.orientationEvent = function orientationEvent(isLandscape) {
          ...
          if (isLandscape) {
            this.heart.node.setPosition(v3(113, -36));
            this.spade.node.setPosition(v3(-113, -36));
            this.heart.node.setScale(Vec3.ONE);
            this.spade.node.setScale(Vec3.ONE);
          } else {
            this.heart.node.setPosition(v3(195, 111));
            this.spade.node.setPosition(v3(-195, 111));
            this.heart.node.setScale(Plug.Model.oneVec3(0.625));
            this.spade.node.setScale(Plug.Model.oneVec3(0.625));
          }
        };
        return M4PanelGameShow;
      }(BasicGameShow), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "spade", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "heart", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "labelResult", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "actionTime", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "showDelayTime", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "winDelayTime", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
System.register("chunks:///_virtual/M4SFBG.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseComponent.ts', './BasicEnum.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "d361dYqJbZHibjK4EXYrkd6", "M4SFBG", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      ...
      var M4SFBG = exports('default', (_dec4 = ccclass('M4SFBG'), _dec5 = property(SFBG), _dec4(_class4 = (_class5 = /*#__PURE__*/function (_BaseComponent) {
        _inheritsLoose(M4SFBG, _BaseComponent);
        function M4SFBG() {
          var _this;
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
...
System.register("chunks:///_virtual/M4SFBonus.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseComponent.ts', './BasicEnum.ts'], function (exports) {
  var _applyDecoratedDescriptor, _initializerDefineProperty, _inheritsLoose, _assertThisInitialized, cclegacy, _decorator, SpriteFrame, BaseComponent, Platform;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
    ...
    execute: function () {
      var _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _dec6, _dec7, _class4, _class5, _descriptor5;
      cclegacy._RF.push({}, "3dc1cbPeahKnYpYAkkVRyMt", "M4SFBonus", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var SFBonus = (_dec = ccclass('SFBonus'), _dec2 = property({
        ...
        _initializerDefineProperty(this, "mobile_EnergyBar", _descriptor, this);
        _initializerDefineProperty(this, "mobile_Energy", _descriptor2, this);
        //<--------------------------------平台分界線-------------------------------------->
        _initializerDefineProperty(this, "web_EnergyBar", _descriptor3, this);
        _initializerDefineProperty(this, "web_Energy", _descriptor4, this);
      }, (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "mobile_EnergyBar", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "mobile_Energy", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "web_EnergyBar", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "web_Energy", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      var M4SFBonus = exports('default', (_dec6 = ccclass('M4SFBonus'), _dec7 = property(SFBonus), _dec6(_class4 = (_class5 = /*#__PURE__*/function (_BaseComponent) {
        _inheritsLoose(M4SFBonus, _BaseComponent);
        function M4SFBonus() {
          var _this;
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          ...
          _this = _BaseComponent.call.apply(_BaseComponent, [this].concat(args)) || this;
          _initializerDefineProperty(_this, "orientationSprite", _descriptor5, _assertThisInitialized(_this));
          return _this;
        }
        return M4SFBonus;
      }(BaseComponent), _descriptor5 = _applyDecoratedDescriptor(_class5.prototype, "orientationSprite", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
System.register("chunks:///_virtual/M4SFGamer.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseComponent.ts', './BasicEnum.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "6038aq63+1D15Sr/tafu6IN", "M4SFGamer", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      // 花色類型枚舉
      var SuitType = exports('SuitType', /*#__PURE__*/function (SuitType) {
        SuitType["Heart"] = "Heart";
        SuitType["Spade"] = "Spade";
        return SuitType;
      }({}));
      var SFGamer = (_dec = ccclass("SFGamer"), _dec2 = property({
        ...
        _initializerDefineProperty(this, "web_cards", _descriptor, this);
        _initializerDefineProperty(this, "mobile_cards", _descriptor2, this);
      }, (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "web_cards", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "mobile_cards", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      var M4SFGamer = exports('default', (_dec4 = ccclass('M4SFGamer'), _dec5 = property({
        type: Enum(SuitType),
        tooltip: "牌的類別"
      }), _dec6 = property(SFGamer), _dec4(_class4 = (_class5 = /*#__PURE__*/function (_BaseComponent) {
        _inheritsLoose(M4SFGamer, _BaseComponent);
        function M4SFGamer() {
          var _this;
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          ...
          _this = _BaseComponent.call.apply(_BaseComponent, [this].concat(args)) || this;
          _initializerDefineProperty(_this, "suit", _descriptor3, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "orientationSprite", _descriptor4, _assertThisInitialized(_this));
          _this.mapWeb = new Map();
          _this.mapMobile = new Map();
          _this.spriteFrames = new Map();
          return _this;
        }
        var _proto = M4SFGamer.prototype;
        _proto.onLoad = function onLoad() {
          var _this2 = this;
          this.orientationSprite.web_cards.forEach(function (_spriteFrame) {
            var tryGetNum;
            tryGetNum = Number(_spriteFrame.name.replace(_this2.suit + "_", ""));
            if (isNaN(tryGetNum)) throw new Error(_spriteFrame + ", \"\u547D\u540D\u6709\u554F\u984C\"");
            _this2.mapWeb.set(tryGetNum, _spriteFrame);
          });
          this.orientationSprite.mobile_cards.forEach(function (_spriteFrame) {
            var tryGetNum;
            tryGetNum = Number(_spriteFrame.name.replace(_this2.suit + "_", ""));
            if (isNaN(tryGetNum)) throw new Error(_spriteFrame + ", \"\u547D\u540D\u6709\u554F\u984C\"");
        ...
        return M4SFGamer;
      }(BaseComponent), (_descriptor3 = _applyDecoratedDescriptor(_class5.prototype, "suit", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class5.prototype, "orientationSprite", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
System.register("chunks:///_virtual/M4SFSelect.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BasicEnum.ts', './BasicSFRandomSelect.ts', './BasicSPButton.ts', './BasicRandomSelect.ts', './SpriteButton.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Label, Platform, SFRandomSelect, BasicSPButton, BasicRandomSelect, SpriteButton;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
      ...
      SFRandomSelect = module.SFRandomSelect;
    }, function (module) {
      BasicSPButton = module.BasicSPButton;
    }, function (module) {
      BasicRandomSelect = module.default;
    }, function (module) {
      SpriteButton = module.default;
    }],
    execute: function () {
      var _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _class4, _class5, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9;
      cclegacy._RF.push({}, "5faf0bvBiBK45+t3yjQWUHN", "M4SFSelect", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var SFSelect = (_dec = ccclass("SFSelect"), _dec2 = property({
        ...
        type: BasicSPButton
      }), _dec(_class = (_class2 = /*#__PURE__*/function (_SFRandomSelect) {
        _inheritsLoose(SFSelect, _SFRandomSelect);
        function SFSelect() {
          var _this;
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _SFRandomSelect.call.apply(_SFRandomSelect, [this].concat(args)) || this;
          _initializerDefineProperty(_this, "mobile_Spade", _descriptor, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "mobile_Heart", _descriptor2, _assertThisInitialized(_this));
          //<--------------------------------平台分界線-------------------------------------->
          _initializerDefineProperty(_this, "web_Spade", _descriptor3, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "web_Heart", _descriptor4, _assertThisInitialized(_this));
          return _this;
        }
        return SFSelect;
      }(SFRandomSelect), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "mobile_Spade", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "mobile_Heart", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "web_Spade", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "web_Heart", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      var M4SFSelect = exports('default', (_dec6 = ccclass('M4SFSelect'), _dec7 = property(SFSelect), _dec8 = property({
        type: SpriteButton,
        tooltip: "黑桃下注按鈕"
      }), _dec9 = property({
        type: SpriteButton,
        ...
        type: Label,
        tooltip: "愛心下注文字"
      }), _dec6(_class4 = (_class5 = /*#__PURE__*/function (_BasicRandomSelect) {
        _inheritsLoose(M4SFSelect, _BasicRandomSelect);
        function M4SFSelect() {
          var _this2;
          for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
            args[_key2] = arguments[_key2];
          }
          _this2 = _BasicRandomSelect.call.apply(_BasicRandomSelect, [this].concat(args)) || this;
          _initializerDefineProperty(_this2, "orientationSprite", _descriptor5, _assertThisInitialized(_this2));
          _initializerDefineProperty(_this2, "btnSpade", _descriptor6, _assertThisInitialized(_this2));
          _initializerDefineProperty(_this2, "btnHeart", _descriptor7, _assertThisInitialized(_this2));
          _initializerDefineProperty(_this2, "labelSpade", _descriptor8, _assertThisInitialized(_this2));
          _initializerDefineProperty(_this2, "labelHeart", _descriptor9, _assertThisInitialized(_this2));
          return _this2;
        }
        var _proto = M4SFSelect.prototype;
        _proto.orientationEvent = function orientationEvent(isLandscape) {
          if (isLandscape) {
            this.btnSpade.normalSprite = this.orientationSprite.web_Spade["default"];
            this.btnSpade.pressedSprite = this.orientationSprite.web_Spade.press;
            this.btnSpade.disabledSprite = this.orientationSprite.web_Spade.disable;
            this.btnSpade.defaultNormalSprite = this.orientationSprite.web_Spade["default"];
            this.btnSpade.defaultSelectSprite = this.orientationSprite.web_Spade.press;
            this.btnHeart.normalSprite = this.orientationSprite.web_Heart["default"];
            this.btnHeart.pressedSprite = this.orientationSprite.web_Heart.press;
            this.btnHeart.disabledSprite = this.orientationSprite.web_Heart.disable;
            this.btnHeart.defaultNormalSprite = this.orientationSprite.web_Heart["default"];
            this.btnHeart.defaultSelectSprite = this.orientationSprite.web_Heart.press;
            this.btnRandom.normalSprite = this.orientationSprite.web_Random["default"];
            this.btnRandom.pressedSprite = this.orientationSprite.web_Random.press;
            this.btnRandom.disabledSprite = this.orientationSprite.web_Random.disable;
            this.btnRandom.defaultNormalSprite = this.orientationSprite.web_Random["default"];
            this.btnRandom.defaultSelectSprite = this.orientationSprite.web_Random.press;
          } else {
            this.btnSpade.normalSprite = this.orientationSprite.mobile_Spade["default"];
            this.btnSpade.pressedSprite = this.orientationSprite.mobile_Spade.press;
            this.btnSpade.disabledSprite = this.orientationSprite.mobile_Spade.disable;
            this.btnSpade.defaultNormalSprite = this.orientationSprite.mobile_Spade["default"];
            this.btnSpade.defaultSelectSprite = this.orientationSprite.mobile_Spade.press;
            this.btnHeart.normalSprite = this.orientationSprite.mobile_Heart["default"];
            this.btnHeart.pressedSprite = this.orientationSprite.mobile_Heart.press;
            this.btnHeart.disabledSprite = this.orientationSprite.mobile_Heart.disable;
            this.btnHeart.defaultNormalSprite = this.orientationSprite.mobile_Heart["default"];
            this.btnHeart.defaultSelectSprite = this.orientationSprite.mobile_Heart.press;
            this.btnRandom.normalSprite = this.orientationSprite.mobile_Random["default"];
            this.btnRandom.pressedSprite = this.orientationSprite.mobile_Random.press;
            this.btnRandom.disabledSprite = this.orientationSprite.mobile_Random.disable;
            this.btnRandom.defaultNormalSprite = this.orientationSprite.mobile_Random["default"];
            this.btnRandom.defaultSelectSprite = this.orientationSprite.mobile_Random.press;
          }
        };
        return M4SFSelect;
      }(BasicRandomSelect), (_descriptor5 = _applyDecoratedDescriptor(_class5.prototype, "orientationSprite", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class5.prototype, "btnSpade", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor7 = _applyDecoratedDescriptor(_class5.prototype, "btnHeart", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor8 = _applyDecoratedDescriptor(_class5.prototype, "labelSpade", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor9 = _applyDecoratedDescriptor(_class5.prototype, "labelHeart", [_dec11], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
System.register("chunks:///_virtual/md5.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "a7910YRiVVDpocsRRMczl1m", "md5", undefined);
...
System.register("chunks:///_virtual/mod.ts", ['cc'], function () {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "543daB9+99DQKd0XAouHKiU", "mod", undefined);
      cclegacy._RF.pop();
    }
  };
});

System.register("chunks:///_virtual/mod2.ts", ['cc', './connack.ts', './connect.ts', './disconnect.ts', './length.ts', './pingreq.ts', './pingres.ts', './puback.ts', './pubcomp.ts', './publish.ts', './pubrec.ts', './pubrel.ts', './suback.ts', './subscribe.ts', './unsuback.ts', './unsubscribe.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "9942aiVtctO0IAo5OQcV8Qi", "mod", undefined);
...
System.register("chunks:///_virtual/mode-cfb.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './cipher-core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "a2410MTdIVP6otLpI+2BoRA", "mode-cfb", undefined);
...
System.register("chunks:///_virtual/mode-ctr-gladman.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './cipher-core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "32056wC+FtB/aDrsPsG3JtW", "mode-ctr-gladman", undefined);
...
System.register("chunks:///_virtual/mode-ctr.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './cipher-core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "a56d7imp8lP+bebQULMNORe", "mode-ctr", undefined);
...
System.register("chunks:///_virtual/mode-ecb.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './cipher-core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "11216x63CpNaZs1FAwGIkl5", "mode-ecb", undefined);
...
System.register("chunks:///_virtual/mode-ofb.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './cipher-core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "e028fYByXBB4ZphmqJgX9BF", "mode-ofb", undefined);
...
System.register("chunks:///_virtual/MyEditBox.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      var _dec, _dec2, _class, _class2, _descriptor, _descriptor2;
      cclegacy._RF.push({}, "c6462ARGxVBvKIqGj7XA04P", "MyEditBox", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var LEFT_PADDING = 2;
...
System.register("chunks:///_virtual/MyMath.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "f88ec3p/HZKsYA4OkBqxPK5", "MyMath", undefined);
...
System.register("chunks:///_virtual/pad-ansix923.js", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "0c7d0SCU4tGr5Jq/tSaEquz", "pad-ansix923", undefined);
      /**
...
System.register("chunks:///_virtual/pad-iso10126.js", ['cc', './core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "c944fIZw8dC77LcpyCpmdOr", "pad-iso10126", undefined);
...
System.register("chunks:///_virtual/pad-iso97971.js", ['cc', './core.js', './pad-zeropadding.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "05509cf9MxGZKhP2BCxwQvy", "pad-iso97971", undefined);
...
System.register("chunks:///_virtual/pad-nopadding.js", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "f0f9dFUsdxPpLzR4o26+OAR", "pad-nopadding", undefined);
      /**
...
System.register("chunks:///_virtual/pad-zeropadding.js", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "6ed015RVZVFcrl7/n05QQmp", "pad-zeropadding", undefined);
      /**
...
System.register("chunks:///_virtual/PageViewOnlyShowItemsInMaskRange.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './AutoFollow.ts', './EventMng.ts', './ScrollViewEvent.ts'], function () {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "2618a2GrCtKDpTVxLW7ZSaJ", "PageViewOnlyShowItemsInMaskRange", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property,
...
System.register("chunks:///_virtual/pbkdf2.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './core.js', './sha1.js', './hmac.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "a875bA3/QFGeoRulcXjdNUf", "pbkdf2", undefined);
...
System.register("chunks:///_virtual/pingreq.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "cfeeaDbArlPeZfe3ZIOi1Zg", "pingreq", undefined);
      function encode(_packet) {
        var packetType = 12;
        var flags = 0;
        return Uint8Array.from([(packetType << 4) + flags, 0]);
...
System.register("chunks:///_virtual/pingres.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "193be5mpQ5ABLzIicc4H1ls", "pingres", undefined);
      function encode(_packet) {
...
System.register("chunks:///_virtual/produce.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './epoch.ts', './is_object.ts', './secs.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "66b49XkxKJDT5ePvtNusIi4", "produce", undefined);
...
System.register("chunks:///_virtual/puback.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "b9f43AlzUdJkLQDKNqzhqJ/", "puback", undefined);
      function encode(packet) {
        var packetType = 4;
        var flags = 0;
...
System.register("chunks:///_virtual/pubcomp.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "8b80eT3ad9A+6LPNfHxjIcM", "pubcomp", undefined);
      function encode(packet) {
        var packetType = 7;
        var flags = 0;
        return Uint8Array.from([(packetType << 4) + flags, 2, packet.id >> 8, packet.id & 0xff]);
...
System.register("chunks:///_virtual/Public.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './MyMath.ts', './BaseSingleton.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "6b86fJYhZJA17EigkqnG6lY", "Public", undefined);
      var Plug;
      (function (_Plug) {
...
System.register("chunks:///_virtual/publish.ts", ['cc', './length.ts', './utf8.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "8f5128rXOFIjZvT/crqy6Ah", "publish", undefined);
      function encode(packet, utf8Encoder) {
        var packetType = 3;
...
System.register("chunks:///_virtual/pubrec.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "4f228375WhF0IraKb8T2NoZ", "pubrec", undefined);
      function encode(packet) {
        var packetType = 5;
        var flags = 0;
        return Uint8Array.from([(packetType << 4) + flags, 2, packet.id >> 8, packet.id & 0xff]);
...
System.register("chunks:///_virtual/pubrel.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "99cafOtWzFBX4WfQcjOM5SY", "pubrel", undefined);
      function encode(packet) {
        var packetType = 6;
        var flags = 2;
        return Uint8Array.from([(packetType << 4) + flags, 2, packet.id >> 8, packet.id & 0xff]);
...
System.register("chunks:///_virtual/rabbit-legacy.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './cipher-core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "d877dpS6r9KYYPx2kLm0lGr", "rabbit-legacy", undefined);
...
System.register("chunks:///_virtual/rabbit.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './cipher-core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "9e3afkIMElKH4csoxkAVWAp", "rabbit", undefined);
...
System.register("chunks:///_virtual/rc4.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './cipher-core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "f1124Br60lHcq/5AiVrXozO", "rc4", undefined);
...
System.register("chunks:///_virtual/Request.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "41a47LJE1hJuKRGOwNVw0iN", "Request", undefined);
...
System.register("chunks:///_virtual/RequestContorl.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseComponent.ts', './M4Enum.ts', './BasicEnum.ts', './RequestData2.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, random, BaseComponent, M4Select, BasicEnum, M4Result;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
      ...
      var RequestContorl = exports('default', (_dec = ccclass('RequestContorl'), _dec(_class = /*#__PURE__*/function (_BaseComponent) {
        ...
        _proto.sendAPI = function sendAPI(sendDate) {
          ...
          if (this.pokerOffsetNum(date.heartCard) > this.pokerOffsetNum(date.spadeCard)) {
            date.isHeartWin = true;
            _sendDate.select == M4Select.Heart ? date.winPoint = 1 : date.winPoint = 0;
          } else if (this.pokerOffsetNum(date.spadeCard) > this.pokerOffsetNum(date.heartCard)) {
            date.isHeartWin = false;
            _sendDate.select == M4Select.Spade ? date.winPoint = 1 : date.winPoint = 0;
          } else date.winPoint = 0;
          console.log(date);
          ...
          console.log(date);
          this.eventEmit(BasicEnum.Result, date);
        ...
        _proto.pokerOffsetNum = function pokerOffsetNum(card) {
          if (card < 3) card += 14; //+13會跟13數字有衝突，因此要多為位移一個數字
          return card;
        };
        _proto.checkWiner = function checkWiner(date) {
          if (date.winPoint > 0) {
            if (this.pokerOffsetNum(date.spadeCard) > this.pokerOffsetNum(date.heartCard)) return true;else return false;
          } else if (this.pokerOffsetNum(date.heartCard) > this.pokerOffsetNum(date.spadeCard)) return true;else return false;
        };
...
System.register("chunks:///_virtual/RequestData.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "3fc8cd2vlNNgICXNFbGyr9k", "RequestData", undefined);
      var Body;
      (function (_Body) {
        var NoMemberID;
...
System.register("chunks:///_virtual/RequestData2.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      var M4Result = exports('M4Result', function M4Result() {
        this.winPoint = void 0;
        this.heartCard = void 0;
        this.spadeCard = void 0;
        this.isHeartWin = void 0;
      });
      cclegacy._RF.pop();
    }
  };
...
System.register("chunks:///_virtual/ResponseData.ts", ['cc'], function () {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "c11180MhqlC+4jmbVrVTBpR", "ResponseData", undefined);
      /**只有純訊息沒有資料 */
      cclegacy._RF.pop();
    }
  };
...
System.register("chunks:///_virtual/ripemd160.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "29416cT5mlH9o5MF0UR5Wkc", "ripemd160", undefined);
...
System.register("chunks:///_virtual/ScreenAdapter%20.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './EventMng.ts', './BasicEnum.ts', './CommonValue.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Prefab, screen, instantiate, director, view, ResolutionPolicy, Component, EventMng, NotificationType, Platform, BasicEnum, CommonValue;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "be26fGY0d5Emq3UOGLTY3Rt", "ScreenAdapter%20", undefined);
      var ccclass = _decorator.ccclass,
      ...
      var ScreenAdapter = exports('default', (_dec = executionOrder(-1), _dec2 = help('https://gitee.com/ifaswind/eazax-ccc/blob/master/components/ScreenAdapter.ts'), _dec3 = menu('eazax/其他组件/ScreenAdapter'), _dec4 = property(Prefab), ccclass(_class = _dec(_class = _dec2(_class = _dec3(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        _proto.onLoad = function onLoad() {
          ...
          // console.log(this.canvas.getComponent(UITransform).contentSize);
        };

        _proto.start = function start() {
          var _this2 = this;
          if (!this.isInit) {
            instantiate(this.prefab).setParent(director.getScene());
            this.scheduleOnce(function (X) {
              return _this2.scheduleOnce(function (x) {
        ...
        _proto.onResize = function onResize() {
          this.scheduleOnce(this.adapt.bind(this), 0);
        ...
        _proto.adapt_v4 = function adapt_v4() {
          ...
          if (!this.isInit) {
            instantiate(this.prefab).setParent(director.getScene());
            this.scheduleOnce(function (X) {
              return _this3.scheduleOnce(function (x) {
                return window.dispatchEvent(new Event("window-resize"));
              }, 0);
            }, 0);
            this.isInit = true;
...
System.register("chunks:///_virtual/ScrollViewEvent.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "abeb01ThstK5ar5Z9ZXzgmr", "ScrollViewEvent", undefined);
...
System.register("chunks:///_virtual/ScrollViewOnlyShowItemsInMaskRange.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './AutoFollow.ts', './EventMng.ts', './ScrollViewEvent.ts'], function () {
  ...
  return {
    ...
    execute: function () {
      var _dec, _dec2, _class;
      cclegacy._RF.push({}, "b6117bpzNhHWI0Y+nb5H+Ia", "ScrollViewOnlyShowItemsInMaskRange", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property,
        menu = _decorator.menu;
...
System.register("chunks:///_virtual/secs.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "8ddd8w5rEFKUJhAIPlMBwzC", "secs", undefined);
      var minute = 60;
      var hour = minute * 60;
      var day = hour * 24;
      var week = day * 7;
...
System.register("chunks:///_virtual/SetBtnEventForKeepTouching.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "e08d0mENxRIKYZMLfYcufg5", "SetBtnEventForKeepTouching", undefined);
...
System.register("chunks:///_virtual/sha1.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "a5ba1ZSuFlOCZK37rFvIh0R", "sha1", undefined);
...
System.register("chunks:///_virtual/sha224.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './core.js', './sha256.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "f1bad7lu/VCbYjhBJVsR7OM", "sha224", undefined);
...
System.register("chunks:///_virtual/sha256.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "3de02i4NgZKQIGG5BolgFRG", "sha256", undefined);
...
System.register("chunks:///_virtual/sha3.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './core.js', './x64-core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "1f9f5sXZTVNwrNDjhrMgrQo", "sha3", undefined);
...
System.register("chunks:///_virtual/sha384.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './x64-core.js', './sha512.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "c145fNQC7dN5KvpGAvuQ937", "sha384", undefined);
...
System.register("chunks:///_virtual/sha512.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './core.js', './x64-core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "d23bfe16nFB8q9sG7Zu4nyw", "sha512", undefined);
...
System.register("chunks:///_virtual/SheetData.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "07b30tTJ/1PdKrT7UCRXqcG", "SheetData", undefined);
...
System.register("chunks:///_virtual/sign.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './sign2.ts', './errors.ts', './buffer_utils.ts', './produce.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "65431g8L15Ky7qjkrukrx5t", "sign", undefined);
...
System.register("chunks:///_virtual/sign2.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './sign3.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "8c83aFoUAZK2o5uT8YV8L5J", "sign", undefined);
      /**
...
System.register("chunks:///_virtual/sign3.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './base64url.ts', './sign4.ts', './buffer_utils.ts', './check_key_type.ts', './is_disjoint.ts', './validate_crit.ts', './errors.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "ffab3PyhexFiYj+kCEOvAsp", "sign", undefined);
...
System.register("chunks:///_virtual/StatePatten.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseSingleton.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "6a641nyCbFFb41toptSlV3z", "StatePatten", undefined);
...
System.register("chunks:///_virtual/suback.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "f88c2UAnU9IHY4TOEYBHNGb", "suback", undefined);
      function encode(packet) {
        var packetType = 9;
        var flags = 0;
...
System.register("chunks:///_virtual/subscribe.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './length.ts', './utf8.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "a01239BxUFCIK7Y0f5ps3FL", "subscribe", undefined);
      function encode(packet, utf8Encoder) {
        var packetType = 8;
...
System.register("chunks:///_virtual/subtle_dsa.ts", ['cc', './errors.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "033e2qObHFE+qJVLAMdvaBK", "subtle_dsa", undefined);
...
System.register("chunks:///_virtual/tripledes.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './core.js', './cipher-core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "1c1deGX8PRD0aKeElpRP7WY", "tripledes", undefined);
...
System.register("chunks:///_virtual/unsuback.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "7d39aJJTABMxrjKen5YnloS", "unsuback", undefined);
      function encode(packet) {
        var packetType = 11;
        var flags = 0;
        return Uint8Array.from([(packetType << 4) + flags, 2, packet.id >> 8, packet.id & 0xff]);
...
System.register("chunks:///_virtual/unsubscribe.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './length.ts', './utf8.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "5f3ectV68tL070nOsLLaIbh", "unsubscribe", undefined);
      function encode(packet, utf8Encoder) {
        var packetType = 10;
        var flags = 2;
        var variableHeader = [packet.id >> 8, packet.id & 0xff];
...
System.register("chunks:///_virtual/utf8.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "7fb4fSHpOFIN7cbc7nYM/+Y", "utf8", undefined); // Deno and browsers have global TextEncoder and TextDecoder classes, but
...
System.register("chunks:///_virtual/validate_crit.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './errors.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "630729TJFFE9JtofRTDHvDX", "validate_crit", undefined);
...
System.register("chunks:///_virtual/webcrypto.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "b531fYT3TxDnrmZxROFPq/r", "webcrypto", undefined);
...
System.register("chunks:///_virtual/x64-core.js", ['./rollupPluginModLoBabelHelpers.js', 'cc', './core.js'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "7df5akkajtHOpgXGDnVxHNw", "x64-core", undefined);
